...
'12.673 cm = 0.12673 m'
\end{lstlisting}
Rezultate lahko sicer zaokrožujemo z vgrajeno funkcijo \text{round}, ki ji kot argument podamo število decimalk. Alternativa je, da zaokroževanje podamo samo pri izpisu, tako da znotraj zavitih oklepajev podamo kako naj se izpis formatira. Takole:
\begin{lstlisting}[language=Python, showstringspaces=false]
>>> cm = 12.673
