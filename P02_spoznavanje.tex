...
\begin{lstlisting}[language=Python, showstringspaces=false, showstringspaces=false, showstringspaces=false, showstringspaces=false]
>>> 1 + 2
3
>>> 1 - 2
-1
...
\begin{lstlisting}[language=Python, showstringspaces=false, showstringspaces=false, showstringspaces=false, showstringspaces=false,numbers=left]
T_C = 20
T_F = T_C * 1.8 +32
\end{lstlisting}
