...
Zadnji način indeksiranja, ki je neodvisen od oznak vrstic in stolpcev, uporablja metodo \texttt{iloc}. Tej podamo številko vrstice lahko pa tudi stolpca. Takole:
\begin{lstlisting}[language=python]
>>> df.iloc[1]
mesec            2014M01
