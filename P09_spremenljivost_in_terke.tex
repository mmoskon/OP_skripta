...
>>> seznam2 = seznam1
\end{lstlisting}
Nekaj podobnega smo srečali že pri klicu funkcije. Spomnimo se, da Python v takem primeru ne ustvari novih objektov v pomnilniku, ampak naredi povezavo na že obstoječe vrednosti. Imeni si v tem primeru torej delita isto (ne enako) vrednost in kažeta na isto pomnilniško lokacijo. Z drugimi besedami to pomeni, da pri prirejanju spremenljivke drugi spremenljivki vrednost v pomnilniku dobi novo ime. Do dejanskega kopiranja vrednosti v tem primeru ne pride \footnote{Dejansko kopiranje spremenljivke bi lahko izvedli z uporabo vgrajenih funkcij \texttt{copy} oziroma \texttt{deepcopy}. Medtem ko prva naredi kopijo podanega objekta, druga naredi kopije tudi vseh objektov, ki jih podani objekt vsebuje.}. To lahko ponazorimo s sliko \ref{img:spremenljivost_2}.
\begin{figure}
    \centering
