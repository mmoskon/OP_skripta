...
d = float(input("Vpiši dolžino: ")) # prvo branje
while d > 0: # dokler je dolžina veljavna
    ime = input("Vpiši ime tekmovalca: ") # branje imena
    skoki.append([d,ime]) # dodajanje podseznama
    d = float(input("Vpisi dolžino: ")) # ponovno branje
skoki.sort(reverse=True)
print("1. mesto:", skoki[0][1], ", dolžina skoka:", skoki[0][0])
print("2. mesto:", skoki[1][1], ", dolžina skoka:",  skoki[1][0])
print("3. mesto:", skoki[2][1], ", dolžina skoka:", skoki[2][0])
\end{lstlisting}
\end{resitev}
