...
%Y 84
%K 0
%\defineCMYKcolor{chapter_col}{15, 100, 84, 0} % svetlejsa
\definecolor{chapter_col}{rgb}{0.851, 0, 0.161} % temnejsa


%\definecolor{chapter_col}{cmyk}{0.0588, 0.3922, 0.3294, 0}
...
\newtheorem{zgled1}{Zgled}
\newtheorem{resitev1}{Rešitev}

%\newenvironment{zgled}%
%  {\begin{mdframed}[backgroundcolor=lightgray]\begin{zgled1}}%
%  {\end{zgled1}\end{mdframed}}

%\newenvironment{resitev}%
%  {\begin{mdframed}[backgroundcolor=lightgray]\begin{resitev1}}%
%  {\end{resitev1}\end{mdframed}}
...
\newenvironment{resitev}%
  {\begin{resitev1}}%
  {\end{resitev1}
  \begin{flushright}$\triangle$\end{flushright}}
...
\lstset{extendedchars=true,basicstyle=\normalfont\ttfamily,showspaces=false,showstringspaces=false,literate=%
{č}{{\v c}}1%
{ž}{{\v z}}1%
{š}{{\v s}}1%
{Č}{{\v C}}1%
...
\include{P01_uvod}
\include{P02_spoznavanje}
\include{P03_If}
\include{P04_while}
\include{P05_seznami}
\include{P06_for}
\include{P07_funkcije}
\include{P08_moduli}
\include{P09_spremenljivost_in_terke}
\include{P10_slovarji}
\include{P11_mnozice}
\include{P12_nizi}
\include{P13_datoteke}
\include{P14_vizualizacija}
\include{P15_numpy}
\include{P16_pandas}
\include{P17_Jupyter}
